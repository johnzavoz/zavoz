...
# Проверка python-dotenv (указан в requirements.txt без версии)
RUN python -c 'import dotenv' 2>/dev/null || (pip install --no-cache-dir python-dotenv>=1.0.0 && echo '✅ python-dotenv установлен автоматически')
